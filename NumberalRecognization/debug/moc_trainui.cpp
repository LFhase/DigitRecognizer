...
QT_MOC_LITERAL(2, 30, 0) // ""
    ...
    "TrainUi\0on_pushButton_clicked\0"
};
...
void TrainUi::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TrainUi *_t = static_cast<TrainUi *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject TrainUi::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TrainUi.data,
      qt_meta_data_TrainUi,  qt_static_metacall, nullptr, nullptr}
};
...
void *TrainUi::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TrainUi.stringdata0))
        return static_cast<void*>(const_cast< TrainUi*>(this));
